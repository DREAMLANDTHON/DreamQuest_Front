...
const DirectInputPopUp = ({isOpen, isClose}) => {
  const container = {
  ...
  return (
    <div style={container}>
      ...
      <Content>
        <Title>새 드림퀘스트 등록하기</Title>
        <form onSubmit={(event) => complete(event)}>
          <InputQuest type="text" name="quest" placeholder="드림퀘스트 내용을 작성해주세요."/>
...
export default DirectInputPopUp;